...
1. **GitHub Security Advisories** (Preferred): [Report via GitHub](https://github.com/LanikSJ/docker-web-service/security/advisories/new)
2. **Email**: Send details to [security@lanik.us](mailto:security@lanik.us)
3. **Security Discussions**: Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/docker-web-service/discussions/categories/security)
4. **Security Issues**: Create a [Security Advisory](https://github.com/LanikSJ/docker-web-service/security/advisories/new)
   on GitHub
...
This project provides a simple web service in a Docker container. Security considerations include:

- **Container Security**: All containers follow security best practices
- **Web Service Security**: Web service is configured with security hardening
...
- Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/docker-web-service/discussions)
- Contact the maintainers through the security email above for sensitive matters

Thank you for helping keep docker-web-service secure!
